...
***Ask not what IntelliPort can do for you - ask what you can do for IntelliPort***
...
2. Include additional information such as:
    ...
    * IntelliPort Debug-Info containing:
...
1. Respect existing IntelliPort coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
