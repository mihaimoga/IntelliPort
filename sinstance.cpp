...
Copyright (c) 1996 - 2019 by PJ Naughter (Web: www.naughter.com, Email: pjna@naughter.com)
...
_Return_type_success_(return != false) bool CInstanceChecker::TrackFirstInstanceRunning(_In_ HWND hWindowToTrack)
{
	...
	const int nMMFSize = sizeof(CWindowInstance);
	if (m_MMF == nullptr)
	{
#pragma warning(suppress: 26477)
	...
	CWindowInstance* pInstanceData = static_cast<CWindowInstance*>(MapViewOfFile(m_MMF, FILE_MAP_WRITE, 0, 0, nMMFSize));
...
#pragma warning(suppress: 26477)
	...
	const int nMMFSize = sizeof(CWindowInstance);
	CWindowInstance* pInstanceData = static_cast<CWindowInstance*>(MapViewOfFile(hPrevInstance, FILE_MAP_READ, 0, 0, nMMFSize));
	if (pInstanceData == nullptr)
	{
...
#pragma warning(suppress: 26472)
		const DWORD dwCmdLength = static_cast<DWORD>(_tcslen(lpCmdLine) + 1);
